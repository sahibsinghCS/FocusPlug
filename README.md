...
10. **Optional — a smart plug.** Add a Kasa or Tapo plug by IP on *Plugs*. With *Lamp on* (the default) it switches on when you drift. Setup: [docs/SMART-PLUGS.md](docs/SMART-PLUGS.md).
