...
async function main(): Promise<void> {
  ...
  writeFileSync(join(dir, "eval-scores.json"), JSON.stringify({ sessionIds: Array.from(evalRows.sessionOf).map((s) => evalRows.sessions[s] as string), scores: evalScoreList }));
