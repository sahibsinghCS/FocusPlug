...
- **model-seam** (PR #13 `cursor/model-seam-f547`): rebased onto latest main (`ec8a054` = #15 on #10/#12). Frozen contracts untouched. `npm test` 159 + `npm run test:desk` **PASS**. Independent critic **WIN** (prior); green after this rebase.
